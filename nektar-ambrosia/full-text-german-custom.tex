...
\definecolor{yellow}{RGB}{233, 171, 23}
...
\patchcmd{\ps@plain}{\thepage}{\bfseries\large\color{yellow}{\thepage}}{}{}
\makeatother
...
\AddToShipoutPictureBG{\includegraphics[width=\paperwidth,height=\paperheight]{ephesus.jpeg}}

\renewcommand\thefootnote{{\bfseries\color{yellow}{\arabic{footnote}}}}
\let\oldfootnote\footnote
    \renewcommand{\footnote}[1]{\oldfootnote{{\normalsize\bfseries\color{yellow}#1}}}
